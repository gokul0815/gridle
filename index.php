  ...
  <div class="row">
      <div class="row">
          <ul class="gridle-common-main-box">
            ...
            <br>
            <li>
            <input type="integer" name="integer" placeholder="Enter the number of values" id="uservalue" style="max-width: 230px; text-align: center; margin: 0 auto 20px; display: block;">             
            </li>
            <li>
              <button onclick="getArray()">Awesome inorder to Proceed Click me</button>
            </li>
          </ul>
      </div>
    </div>
